...
public class ViewSellerDetailFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(R.layout.fragment_viewsellerdetail, container, false);
        assert listing != null;
        ...
        titleOffering.setText(String.format("Title of Book Offering: %s", listing.getBookAndAuthorName().get(0)));
    ...
    private void composeEmail(StringBuilder titles, StringBuilder authors) {
        ...
        i.putExtra(Intent.EXTRA_SUBJECT, "Requesting a trade for your book: " + listing.getBookAndAuthorName()
                ...
                + listing.getIsbn() + ")"
                + " by "
                + listing.getBookAndAuthorName().get(1));
        ...
        String body = "Hello " + listing.getName() + ",\n\n" + "I am interested in your book and I want " +
                "to trade for it. I am offering these book(s):\n\n" + booksOffering.toString() + "\n\nIf you are willing to directly " +
                "to sell it to me, please let me know." + "\n\nThanks,\n" +
