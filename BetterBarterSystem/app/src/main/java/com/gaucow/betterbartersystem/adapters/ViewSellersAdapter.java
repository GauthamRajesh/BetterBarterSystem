...
import com.gaucow.betterbartersystem.activities.ViewSellerDetailActivity;
...
public class ViewSellersAdapter extends RecyclerView.Adapter<ViewAllBooksVH> {
    private ArrayList<Listing> listings;
    private Context c;
    public ViewSellersAdapter(ArrayList<QuerySnapshot> data, Context c) {
    ...
    public void onBindViewHolder(@NonNull ViewAllBooksVH holder, int position) {
        ...
        holder.viewDetailsButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(c, ViewSellerDetailActivity.class);
